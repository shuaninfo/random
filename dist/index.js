...
var randomBytesAsync = _util.promisify.call(void 0, _crypto2.default.randomBytes);
...
var generateForCustomCharacters = (length, characters) => {
  ...
  while (stringLength < length) {
    const entropy = _crypto2.default.randomBytes(entropyLength);
...
var generateRandomBytes = (byteLength, type, length) => _crypto2.default.randomBytes(byteLength).toString(type).slice(0, length);
